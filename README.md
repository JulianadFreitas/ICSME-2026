...
```
ROS Index (JSON)           ROSDisto YAML files
       ↓                           ↓
   (Script 00)              (Script 01)
       ↓                           ↓
    [Cache]                  [Mapping]
...
**RQ1**: What is the proportion of newcomers who eventually onboard an ROS project?

**RQ2**: What kinds of repositories does a newcomer contributing to ROS target?

**RQ3**: What are the kinds of first contributions that come from newcomers in ROS?

**RQ4**: To what extent do ROS packages comply with community-related OSS practices that support newcomer onboarding?

**RQ5**: To what extent do project characteristics influence the onboarding of newcomers in OSS projects?

## Exclusion Criteria

Packages are excluded if they meet any of these criteria:

- **Inactive/archived**: No commits in the last 6 months
- **Non-software**: Content-only repositories without software functionality
- **Duplicates/forks**: Same package in multiple distributions or forked repositories
- **Non-GitHub**: Hosted on platforms other than GitHub
...
- Newcomer OSS-Candidates: Characterizing Contributions of Novice Developers to GitHub (EMSE'22)
- Off to a Good Start: Dynamic Contribution Patterns and Technical Success in an OSS Newcomer's Early Career (TSE'23)
- The role of mentoring and project characteristics for onboarding in open source software projects (ESEM'14)
- What Attract Newcomers to Onboard on OSS Projects? (OSS'19)
...
```bibtex
@dataset{ros_onboarding_2026,
  title={ROS Newcomer Onboarding Analysis Dataset},
  author={[Authors]},
  year={2026},
  url={[Repository URL]}
}
...
[Add appropriate license - MIT, CC-BY, etc.]

## Contact

For questions about this dataset, please open an issue on the repository.
